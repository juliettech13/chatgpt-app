...
import { alternativesInputSchema, bookInputSchema, fetchInputSchema, searchInputSchema, textContent } from "./lib/schemas.js";
...
function createServer() {
    ...
    server.registerResource("parking-browser-widget", RESOURCE_URI, {
    ...
    server.registerTool("search", {
        ...
        description: "Search ACME parking lots for a user request. Prefer passing canonical filters when possible. This tool defaults to today and renders the widget from this call.",
        ...
        return {
            ...
            content: textContent(lots.length
                ? [
    ...
    server.registerTool("get_parking_alternatives", {
    ...
    server.registerTool("book_parking", {
        ...
        return {
            ...
            content: textContent(`Mock booking confirmed for ${selectedLot.name} on ${resolvedDate}. Confirmation: ${confirmationCode}.`)
        };
    });
    return server;
}
